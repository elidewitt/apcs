 ...
 * @version 2/10/2022
 * 
 * @PMR This assignment was interested. It highlighted important parts
 * of debugging. Like which if else statements need to come first/last
 *
 */
public class Magpie4
{
    ...
    {
        return randomResponse[(int) (Math.random() * randomResponse.length)];
    }
}

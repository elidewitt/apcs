public class ElectionTesterV3 {
    ...
    public static void setCandidateVotes(Candidate [] candidates, String find, int votes) {
        Boolean updated = false;
        for (Candidate candidate : candidates) {
            if (candidate.getName() == find) {
    ...
    public static void setCandidate(Candidate [] candidates, String find, String name, int votes) {
        Boolean updated = false;
        for (Candidate candidate : candidates) {
            if (candidate.getName() == find) {
                candidate.setName(name);

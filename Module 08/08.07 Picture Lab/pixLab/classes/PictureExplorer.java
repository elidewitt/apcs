/**
 * Purpose: Learn more about 2d arrays with images and others.
 * 
 * @author Eli R DeWitt
 * @version 2/22/2022
 * 
 * @PMR This was relatively easy, the instructions were easy to
 * understand and the concepts were intuitive.
*/
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  public static void main( String args[])
  {
    ...
    Picture p = new Picture("images/neo.jpg");
    Picture smallP = p.scale(0.25, 0.25);
    smallP.write("smallNeo.jpg");
    smallP.explore();
